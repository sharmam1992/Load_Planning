		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Load Planning",
									"targetURL": "#comdpzloadplanning-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdpzloadplanning-display": {
								"semanticObject": "comdpzloadplanning",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dpz.loadplanning",
									"url": sap.ui.require.toUrl("com/dpz/loadplanning")
								}
							}
						}
					}
